...
define('DB_NAME', 'heroku_a73c731ed74ded1');

/** MySQL database username */
define('DB_USER', 'b0a5409fd2f0b2');

/** MySQL database password */
define('DB_PASSWORD', 'fd19f8be');

/** MySQL hostname */
define('DB_HOST', 'mysql://b0a5409fd2f0b2:fd19f8be@us-cdbr-iron-east-02.cleardb.net/heroku_a73c731ed74ded1?reconnect=true');
